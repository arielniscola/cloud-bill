...
const STATUS_VARIANT: Record<string, StatusVariant> = {
  DRAFT: 'default', ISSUED: 'info', AUTHORIZED: 'authorized', PAID: 'success', CANCELLED: 'error', PARTIALLY_PAID: 'warning',
};
...
const BADGE_CLASS: Record<StatusVariant | OPStatusVariant, string> = {
  ...
  authorized: 'bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400',
};
