    ...
    <label
      ...
      className={`flex items-center gap-4 p-4 rounded-xl border cursor-pointer transition-all duration-150 select-none ${
        checked
          ...
          : 'bg-gray-50 dark:bg-slate-700/50 border-gray-200 dark:border-slate-600 hover:border-gray-300 dark:hover:border-slate-500 hover:bg-gray-100/60 dark:hover:bg-slate-700'
      }`}
    >
      <div
        className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors duration-150 ${
          checked ? 'bg-indigo-100 dark:bg-indigo-900/40 text-indigo-500 dark:text-indigo-400' : 'bg-white dark:bg-slate-800 text-gray-400 dark:text-slate-500 border border-gray-200 dark:border-slate-600'
        }`}
      >
        {icon}
      </div>
      ...
      <div className="flex-1 min-w-0">
        <p className={`text-sm font-medium leading-tight ${checked ? 'text-indigo-800 dark:text-indigo-300' : 'text-gray-700 dark:text-slate-300'}`}>
          {label}
        </p>
  ...
  return (
    <Card className="max-w-xl animate-pulse">
      <div className="space-y-6">
        <div>
          <div className="h-3.5 w-16 bg-gray-100 dark:bg-slate-700 rounded mb-2" />
          <div className="h-10 bg-gray-100 dark:bg-slate-700 rounded-lg" />
        </div>
        <div>
          <div className="h-3.5 w-20 bg-gray-100 dark:bg-slate-700 rounded mb-2" />
          <div className="h-10 bg-gray-100 dark:bg-slate-700 rounded-lg" />
        </div>
        ...
        <div className="flex gap-3 pt-2">
          <div className="h-9 w-32 bg-gray-100 dark:bg-slate-700 rounded-lg" />
          <div className="h-9 w-20 bg-gray-100 dark:bg-slate-700 rounded-lg" />
        </div>
      </div>
    </Card>
  );
