        ...
        >
          {optional && (
            <button
              ...
              onClick={handleClear}
              className="w-full flex items-center gap-2 px-3 py-2.5 text-sm text-gray-400 hover:bg-gray-50 border-b border-gray-100 transition-colors"
            >
    ...
    <div ref={containerRef} className="relative w-full">
      ...
      {!isOpen ? (
        ...
        >
          {selected ? (
            <>
              <span className="font-mono text-[10px] font-semibold bg-indigo-50 text-indigo-600 border border-indigo-100 px-1.5 py-0.5 rounded flex-shrink-0">
                {selected.sku}
              </span>
        ...
        <div className={`flex items-center gap-2 px-3 py-2 rounded-lg border bg-white focus-within:ring-2 focus-within:ring-indigo-500/30 focus-within:border-indigo-400 ${
          error ? 'border-red-300' : 'border-indigo-400'
        }`}>
